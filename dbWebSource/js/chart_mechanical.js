    ...
    if(gPrmCategory==="Region" || gPrmCategory==="Market"){
        ...
        _html +="<thead>"
                +"<tr>"
                    ...
                    $.each(_categoryKeyObj, function(i, v){
                        var _rSpan = (_o.location ? (v.color=="gray") ? 2 : 1 : 1);
                        var _cSpan = (_o.location ? (v.color=="gray") ? 1 : gCategories.length : 1);
        ...
        _html += "<tbody>"; 
                $.each(_selectedCategory, function(i, rm){
                    var _rm = rm.name;
                    _html += "<tr>"
                            + "<th class='text-center' rowspan="+ _myLength +">"+ _rm +"</th>";
                    ...
                    $.each(gModelYears, function(i, my){
                        ...
                        $.each(_categoryKeyObj, function(i, x){
                            var _cValue = 0;
                            var _cName = x.name;
                            var _res2 = _o.data.filter(function(item){
        ...
        _html +="<thead>"
            ...
            _html +="<tbody>"; 
                $.each(_categoryKeyObj, function(i, cat){
                    ...
                    var _ret = _o.data.filter(function(item){
                    ...
                    $.each(_selectedCategory, function(i, v){
                        var _val = 0;
                        var _res = _o.data.filter(function(item){
        ...
        _html += "<tfoot>"
                ...
                $.each(_selectedCategory, function(i, z){
                    var _res4 = _o.data.filter(function(item){
...
function filterGraphData(e){
    ...
    gPrmCategory = $.trim($("#category").val());
    gPrmSubCategory = $.trim($("#sub_category").val());
    gPrmGraphType = $.trim($("#graph_type").val());
        ...
        getCriteriaParams(function(){
            getLegendData(function(){
                ...
                getData(_res.url, function(){
                    ...
                    $("#chart_div, #chart_details, #trends, #opportunities, #sunburst_details, #bar_details").empty().width("auto");
...
function displayDetailsSunburst(container, data, hasDummy){
    ...
    level1SeriesTemplate.tooltip.label.width = 300;
    ...
    level2SeriesTemplate.tooltip.label.width = 300;
}

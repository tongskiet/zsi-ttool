        ...
        ,dataRows       :[
            ...
            ,{ text:"" ,width:35 , style:"text-align:left;"
		        ,onRender   :   function(d){
		            ...
		            return (d !==null && d.pcriteria_id!=="" ? _link : "" );
		        }
    		}
...
function displayChartMechanical(criteriaId){
    ...
    getDataByCriteriaId(criteriaId, function(){
        ...
        if(_menu === "Coverings"){
            ...
            setCharTemplate(criteriaId, 1, function(container){
                displayChartGrommets(container[0]);
            });
        }
    });
}
...
// Grommets
function displayChartGrommets(container, callback){
    if(gData.length > 0){
        var _region = gData.groupBy(["REGION_NAME"]);
        var _modelYear = gData.groupBy(["MODEL_YEAR"]);
        var _locationDtl = gData.groupBy(["location_dtl"]);
...
// function displayRetainerSealingBar(criteriaId ,callback){
//     var dataRows = [];
//     $.get(execURL + "dynamic_retainers_sel @byRegion='Y',@byMY='Y',@criteria_id="+ criteriaId 
//     , function(data){
//         dataRows = data.rows;

        ...
        getSubMenu(function(rows){
            ...
            $(rows).each(function(i, v){
                if(v.pcriteria_id !== ""){
                    ...
                    var _cLink = "chart_mechanical?menu="+ gMenuName.replace(/&/g, '_') +"&id="+ _cId +"&name="+ _cTitle.replace(/&/g, '_') + "&c=" + gMenuCount + "&mtype=" + gMenuType;
...
function displayChartCriteria(){
    var _time = 500;
    $(gCriteriaRows).each(function(i, v){
        if(v.pcriteria_id !== ""){
            var _cId = v.criteria_id;  
            var _cName = $.trim(v.criteria_title);
...
function setChartSettings(o){
    if(!$.isEmptyObject(o)){
        ...
        if(isContain(gMenuName, "WIRES & CABLES")){
            
        }
        else if(isContain(gMenuName, "INLINE CONNECTOR")){
            
        }
        else if(isContain(gMenuName, "GROUND EYELET") || isContain(gMenuName, "SPLICE") || isContain(gMenuName, "BATTERY FUSE TERMINAL")){
        ...
        else if(isContain(gMenuName, "COVERINGS")){
        ...
        else if(isContain(gMenuName, "RETAINERS")){
        ...
        else if(isContain(gMenuName, "GROMMETS")){
        ...
        else if(isContain(gMenuName, "TROUGH/SHIELD/BRACKET")){
